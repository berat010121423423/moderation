...
if (!kullanıcı) return message.channel.send('<a:croz:806650760104247327> **Bir Hata Oluştu** <a:croz:806650760104247327>\n\`Yanına Çağırmak İstediğin Kullanıcıyı Etikle.\`');

let member = message.guild.member(kullanıcı);

if (!member.voice.channel) return message.channel.send('<a:croz:806650760104247327> **Bir Hata Oluştu** <a:croz:806650760104247327>\n\`Yanına Çağırmak İstediğin Kişi Ses Kanalında Değil.\`').then(m => m.delete,{timeout: 5000});
