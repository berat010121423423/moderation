...
if(!["805738640901668893",].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("VIEW_AUDIT_LOG"))) 
...
const banlog = message.guild.channels.cache.find(c => c.id === '805738644710359067')//Ban Log 
