...
if(!["805738640901668887"].some(role => message.member.roles.cache.get(role)) && (!message.member.hasPermission("VIEV_AUDIT_LOG"))) 
...
const mutelog = message.guild.channels.cache.find(c => c.id === '805738644710359063')//mute log
